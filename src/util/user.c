...
static void user_usage_free(/*_Atomic (unsigned long)*/atomic_ulong *n_refs, void* userdata) {
...
void user_free(/*_Atomic (unsigned long)*/atomic_ulong *n_refs, void* userdata) {
