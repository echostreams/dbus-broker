...
#else
        case BUS_MATCH_ARG:
        case BUS_MATCH_ARG + 1:
        case BUS_MATCH_ARG + 2:
        case BUS_MATCH_ARG + 3:
        case BUS_MATCH_ARG + 4:
        case BUS_MATCH_ARG + 5:
        case BUS_MATCH_ARG + 6:
        case BUS_MATCH_ARG + 7:
        case BUS_MATCH_ARG + 8:
        case BUS_MATCH_ARG + 9:
        case BUS_MATCH_ARG + 10:
        case BUS_MATCH_ARG + 11:
        case BUS_MATCH_ARG + 12:
        case BUS_MATCH_ARG + 13:
        case BUS_MATCH_ARG + 14:
        case BUS_MATCH_ARG + 15:
        case BUS_MATCH_ARG + 16:
        case BUS_MATCH_ARG + 17:
...
#else
        default:
            if (node->type >= BUS_MATCH_ARG && node->type <= BUS_MATCH_ARG_LAST) {
                (void)bus_message_get_arg(m, node->type - BUS_MATCH_ARG, &test_str);
                break;
            }
            else if (node->type >= BUS_MATCH_ARG_PATH && node->type <= BUS_MATCH_ARG_PATH_LAST) {
                (void)bus_message_get_arg(m, node->type - BUS_MATCH_ARG_PATH, &test_str);
                break;
            }
            else if (node->type >= BUS_MATCH_ARG_NAMESPACE && node->type <= BUS_MATCH_ARG_NAMESPACE_LAST) {
                (void)bus_message_get_arg(m, node->type - BUS_MATCH_ARG_NAMESPACE, &test_str);
                break;
            }
            else if (node->type >= BUS_MATCH_ARG_HAS && node->type <= BUS_MATCH_ARG_HAS_LAST) {
                (void)bus_message_get_arg_strv(m, node->type - BUS_MATCH_ARG_HAS, &test_strv);
                break;
            }
            else {
...
#else
        default:
            if (t >= BUS_MATCH_ARG && t <= BUS_MATCH_ARG_LAST)
                return __snprintf_ok(buf, l, "arg%i", t - BUS_MATCH_ARG);
            else if (t >= BUS_MATCH_ARG_PATH && t <= BUS_MATCH_ARG_PATH_LAST)
                return __snprintf_ok(buf, l, "arg%ipath", t - BUS_MATCH_ARG_PATH);
            else if (t >= BUS_MATCH_ARG_NAMESPACE && t <= BUS_MATCH_ARG_NAMESPACE_LAST)
                return __snprintf_ok(buf, l, "arg%inamespace", t - BUS_MATCH_ARG_NAMESPACE);
            else if (t >= BUS_MATCH_ARG_HAS && t <= BUS_MATCH_ARG_HAS_LAST)
                return __snprintf_ok(buf, l, "arg%ihas", t - BUS_MATCH_ARG_HAS);
            else
                return NULL;
#endif
        }
