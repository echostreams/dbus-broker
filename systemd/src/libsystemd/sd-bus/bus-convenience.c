...
const char* __make_expression(const char *sender, const char *path, const char *_interface, const char *member) {
    const char* _appendees_[] = { "type='signal'",                                
                sender ? ",sender='" : "",                      
                sender ? sender : "",                           
                sender ? "'" : "",                              
                path ? ",path='" : "",                          
...
#define make_expression(sender, path, _interface, member)       \
        strjoina(                                               \
                "type='signal'",                                \
                sender ? ",sender='" : "",                      \
                sender ? sender : "",                           \
...
_public_ int sd_bus_match_signal(
        ...
        expression = __make_expression(sender, path, interface, member);
