...
#define LIST_PREPEND(name,t,head,item)                                    \
        do {                                                            \
                /*typeof(*(head))*/t **_head = &(head), *_item = (item);     \
                assert(_item);                                          \
...
#define LIST_REMOVE(name,t,head,item)                                   \
        do {                                                            \
...
#define LIST_INSERT_AFTER(name,t, head,a,b)                                \
        do {                                                            \
                /*typeof(*(head))*/t **_head = &(head), *_a = (a), *_b = (b); \
                assert(_b);                                             \
                if (!_a) {                                              \
...
#define LIST_INSERT_BEFORE(name,t,head,a,b)                               \
        do {                                                            \
                /*typeof(*(head))*/t **_head = &(head), *_a = (a), *_b = (b); \
                assert(_b);                                             \
                if (!_a) {                                              \
