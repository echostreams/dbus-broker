...
static inline bool ERRNO_IS_TRANSIENT(int r) {
        ...
        //              EAGAIN,
        //              EINTR);
    return abs(r) == EAGAIN || abs(r) == EINTR;
}
...
static inline bool ERRNO_IS_RESOURCE(int r) {
        ...
        return IN_SET(abs(r),
                      ...
                      ENOMEM);
#else
    return abs(r) == EMFILE || abs(r) == ENFILE || abs(r) == ENOMEM;
#endif
}
...
static inline bool ERRNO_IS_NOT_SUPPORTED(int r) {
        ...
        return IN_SET(abs(r),
                      ...
                      ESOCKTNOSUPPORT);
#else
    return (abs(r) == EOPNOTSUPP ||
        abs(r) == ENOTTY ||
        abs(r) == ENOSYS ||
        abs(r) == EAFNOSUPPORT ||
        abs(r) == EPFNOSUPPORT ||
        abs(r) == EPROTONOSUPPORT ||
        abs(r) == ESOCKTNOSUPPORT);
#endif
}
...
static inline bool ERRNO_IS_PRIVILEGE(int r) {
        ...
        return IN_SET(abs(r),
                      ...
                      EPERM);
#else
    return abs(r) == EACCES || abs(r) == EPERM;
#endif
}
...
static inline bool ERRNO_IS_DISK_SPACE(int r) {
        ...
        return IN_SET(abs(r),
                      ...
                      EFBIG);
#else
    return abs(r) == ENOSPC || abs(r) == EDQUOT || abs(r) == EFBIG;
#endif
}
